...
*/
IF EXISTS ( SELECT * FROM SYSOBJECTS WHERE NAME = 'sp_SMS_getAllNormalMessInbox') 
BEGIN
	DROP PROC sp_SMS_getAllNormalMessInbox
END
GO
CREATE PROC sp_SMS_getAllNormalMessInbox
AS
BEGIN

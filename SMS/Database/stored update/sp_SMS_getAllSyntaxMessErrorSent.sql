...
*/
IF EXISTS ( SELECT * FROM SYSOBJECTS WHERE NAME = 'sp_SMS_getAllSyntaxMessErrorSent') 
BEGIN
	DROP PROC sp_SMS_getAllSyntaxMessErrorSent
END
GO
CREATE PROC sp_SMS_getAllSyntaxMessErrorSent
AS
BEGIN

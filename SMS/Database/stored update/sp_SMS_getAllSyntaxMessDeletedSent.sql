...
*/
IF EXISTS ( SELECT * FROM SYSOBJECTS WHERE NAME = 'sp_SMS_getAllSyntaxMessDeletedSent') 
BEGIN
	DROP PROC sp_SMS_getAllSyntaxMessDeletedSent
END
GO
CREATE PROC sp_SMS_getAllSyntaxMessDeletedSent
AS
BEGIN

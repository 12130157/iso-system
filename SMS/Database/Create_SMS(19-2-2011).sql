...
CREATE TABLE [LoaiTinNhan] (
    ...
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_LoaiTinNhan] PRIMARY KEY ([ID])
)
GO
...
ALTER TABLE [HopThuDen] ADD CONSTRAINT [LoaiTinNhan_HopThuDen] 
    FOREIGN KEY ([Loai_tin_nhan]) REFERENCES [LoaiTinNhan] ([ID])
GO

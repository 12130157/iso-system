	...
	<form>
		...
		<table>
			<tr style="background-color: transparent;">
				<td colspan="9">
					<div class = "div_thanhvientieude">Di Chuyển Các Thiết Bị</div>
				</td>
			</tr>
		</table>
			...
			<table>
				<tr>
					<td><select name="cboPhong1" ><option>--Chọn phòng--</option></select></td>
					<td></td>
					<td><select name="cboPhong2" ><option>--Chọn phòng--</option></select></td>
				
				</tr>
				
				<tr>
					<td>	
						<select multiple="multiple" size="5" name="cboThietBiPhong1" id="cboThietBiPhong1">
						</select>
					</td>
					<td>
					...
					<td>
						<select multiple="multiple" size="5" name="cboThietBiPhong2" id="cboThietBiPhong2">
						</select>
					</td>
				</tr>

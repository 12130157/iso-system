...
<div class = "div_pagebody">
	...
	<form action="<%=request.getContextPath()%>/GiaoAnController" method="post" name="GiaoAn">
		...
		<table width = "800" style="background-color: transparent;">
			...
			<tr style="background-color: transparent;">
				<td colspan = "2">		
					<textarea  rows="2" name="txtODLH" id="txtODLH" cols="90" style="background-color: transparent;"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.onDinhLH}</c:if></textarea>
		...
		<table border = "1" style="background-color: transparent;">
			...
			<tr style="background-color: transparent;">
				...
				<td>Dẫn nhập : <a id="aDanNhap"></a><br />
					<textarea  cols="20" style="cursor:pointer; background-color: transparent;" id ="txtDanNhap" name="txtDanNhap" rows = "2" style="background-color: transparent;" readonly="readonly" onclick="showPopUp(this.id)">${giaoAnLyThuyet.danNhap}</textarea>
				
				</td>
				<td>
					<a id="aHDDNGV"></a>
					<textarea onclick="showPopUp(this.id)" rows="2" cols="20" style="cursor:pointer;background-color: transparent;" name="txtHDDNGV" id="txtHDDNGV" readonly="readonly"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDDanNhapGV}</c:if></textarea>
					
				</td>
				<td>
					<a id="aHDDNHS"></a>
					<textarea onclick="showPopUp(this.id)" rows="2" cols="20"style="cursor:pointer;background-color: transparent;" name="txtHDDNHS" id="txtHDDNHS" readonly="readonly"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDDanNhapHS}</c:if></textarea>
			...
			<tr style="background-color: transparent;">
				...
				<td>Giảng bài mới : <a id="aGiangBaiMoi"></a><br />
					<textarea onclick="showPopUp(this.id)" cols="20" style="cursor:pointer;background-color: transparent;" id="txtGiangBaiMoi" name="txtGiangBaiMoi" readonly="readonly" style="background-color: transparent;"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.noiDungBaiGiang}</c:if></textarea>
					
				</td>
				<td>
					<a id="aGiangBaiMoiGV"></a>
					<textarea rows="2" cols="20" style="background-color: transparent;" name="txtGiangBaiMoiGV" id="txtGiangBaiMoiGV" readonly="readonly">${chiTietKHGD.tenChuong}</textarea>	
					
				</td>
				<td>
					<a id="aGiangBaiMoiHS"></a>
					<textarea onclick="showPopUp(this.id)" rows="2" cols="20" style="cursor:pointer;background-color: transparent;" name="txtGiangBaiMoiHS" id="txtGiangBaiMoiHS" readonly="readonly" ><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDGiangBaiMoiHS}</c:if></textarea>
			...
			<tr style="background-color: transparent;">
				...
				<td>Củng cố kiến thức và kết thúc bài : <a id="aCungCoKienThuc"></a><br />
					<textarea onclick="showPopUp(this.id)" cols="20" readonly="readonly" style="cursor:pointer;background-color: transparent;" id ="txtCungCoKienThuc" name="txtCungCoKienThuc" rows = "2" style="background-color: transparent;" ><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.cungCoKienThuc}</c:if></textarea>
					
				</td>
				<td>
					<a id="aCungCoGV"></a>
					<textarea onclick="showPopUp(this.id)" rows="2"  readonly="readonly" cols="20" style="cursor:pointer;background-color: transparent;" id="txtCungCoGV" name="txtCungCoGV"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDCungCoGV}</c:if></textarea>
					
				</td>
				<td>
					<a id="aCungCoHS"></a>
					<textarea onclick="showPopUp(this.id)" rows="2" readonly="readonly" cols="20" style="cursor:pointer;background-color: transparent;" id="txtCungCoHS" name="txtCungCoHS"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDCungCoHS}</c:if></textarea>
			...
			<tr style="background-color: transparent;">
				...
				<td>Hướng dẫn tự học : <a id="aHDTH"></a> <br />
					<textarea readonly="readonly" onclick="showPopUp(this.id)" cols="20" style="cursor:pointer;background-color: transparent;" id ="txtHDTH" name="txtHDTH" rows = "2" ><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.huongDanTuHoc}</c:if></textarea>
					
				</td>
				<td>
					<a id="aHDTHGV"></a>
					<textarea readonly="readonly" onclick="showPopUp(this.id)" cols="20" style="cursor:pointer;background-color: transparent;" id ="txtHDTHGV" name="txtHDTHGV" rows = "2"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDHDTHGV}</c:if></textarea>
					
				</td>
				<td>
					<a id="aHDTHHS"></a>
					<textarea readonly="readonly" onclick="showPopUp(this.id)" cols="20" style="cursor:pointer;background-color: transparent;" id ="txtHDTHHS" name="txtHDTHHS" rows = "2"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.HDHDTHHS}</c:if></textarea>
			...
			<tr style="background-color: transparent;">
				...
				<td colspan = "3">
					<textarea  rows="4" cols="55" style="background-color: transparent;" id ="txtTaiLieuThamKhao" name="txtTaiLieuThamKhao"><c:if test="${param.stt eq 'update'}">${giaoAnLyThuyet.taiLieuThamKhao}</c:if></textarea>
		...
		<table style="background-color: transparent;">
			<tr style="background-color: transparent;">
				...
				<td>
					<!-- <input type = "text" id="txtCalendar1" size = 8 name="txtCalendar1" style="background-color: transparent;" readonly="readonly" <c:if test="${param.stt eq 'update'}">value="${giaoAnLyThuyet.ngayTao}"</c:if>/>-->

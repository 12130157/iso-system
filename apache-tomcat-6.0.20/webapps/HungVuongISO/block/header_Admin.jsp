...
<c:set var="sysRoleAppMenuList" value='<%= SysRoleMenuDAO.findSysRoleAppMenu(session.getAttribute("maBoPhan").toString(), Constant.APP_ADMIN) %>'></c:set>
...
<div class = "header">
  ...
  <div class="dock-container">
	<c:set var="chucNangMenu" value='<%= Constant.CHUCNANG_ADMIN_MENU %>'></c:set>

	...
	<c:forEach var="iterator" begin="1" end="${num}" step="3" >
		<tr style="background-color: transparent;">
			<td>	
				...
				<div class = "icon">
					<a class="linkHome" href = "${AppObj1.appLink}"><img src="${AppObj1.appImage}" alt="${AppObj1.appName}"  border = "0px"/><br/>${AppObj1.appName}</a>					
				</div>
				</c:if>
			</td>
			<td>				
				...
				<div class = "icon">
					<a class="linkHome" href = "${AppObj2.appLink}"><img src="${AppObj2.appImage}" alt="${AppObj2.appName}" border="0px"/><br/>${AppObj2.appName}</a>					
				</div>
				</c:if>
			</td>
			<td>					
				...
				<div class = "icon">
					<a class="linkHome" href = "${AppObj3.appLink}"><img src="${AppObj3.appImage}" alt="${AppObj3.appName}" border="0px"/><br/>${AppObj3.appName}</a>					
				</div>
				</c:if>
			</td>	
		</tr>

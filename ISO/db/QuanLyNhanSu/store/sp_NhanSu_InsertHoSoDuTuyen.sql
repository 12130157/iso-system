...
BEGIN  
	...
	BEGIN  
		INSERT INTO HoSoDuTuyen VALUES(@Ten_dang_nhap,@Ho,@Ten_lot,@Ten,@Gioi_tinh,@Ngay_sinh,null,@CMND,@So_nha,@Duong,@Phuong_xa,@Quan_huyen,@Tinh_thanhpho,@Dien_thoai_nha,@Email,@Dien_thoai_dd,@Trinh_do_van_hoa,@Chuyen_mon,@Tin_hoc,@Ngoai_ngu,@Tom_tat_ban_than,@Vi_tri_du_tuyen,0,GETDATE(),'','','','','')
		SET @KQ = 1  
	END  
END  
GO

...
ALTER TABLE [ThietBi] ADD CONSTRAINT [ThanhVien_ThietBi] 
    FOREIGN KEY ([Ma_nguoi_tao]) REFERENCES [ThanhVien] ([ID])
GO
...
ALTER TABLE [PhieuMuonThietBi] ADD CONSTRAINT [ThanhVien_PhieuMuonThietBi] 
    FOREIGN KEY ([Nguoi_muon]) REFERENCES [ThanhVien] ([ID])
GO
...
ALTER TABLE [ChiTietPhieuMuon] ADD CONSTRAINT [ThietBi_ChiTietPhieuMuon] 
    FOREIGN KEY ([Ma_thiet_bi]) REFERENCES [ThietBi] ([ID])
GO

ALTER TABLE [ChiTietPhieuMuon] ADD CONSTRAINT [TinhTrangThietBi_ChiTietPhieuMuon] 
    FOREIGN KEY ([Tinh_trang]) REFERENCES [TinhTrangThietBi] ([ID])
GO

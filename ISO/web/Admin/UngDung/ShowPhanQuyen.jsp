...
<div align="center">
	...
	<tr>
		<td></td>
		<td><form action="<%=request.getContextPath()%>/ThietBiController?actionType=PhanQuyen&actionStatus=themAll&appID=${param.appID}" name="ActionChuaPhanQuyenAll" id="ActionChuaPhanQuyenAll" method="post" enctype="application/x-www-form-urlencoded">

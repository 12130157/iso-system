...
<table width="1000" height="691" bgcolor="#808080" align="center" style="background-image: url('<%=request.getContextPath()%>/images/background_print.jpg');">
	...
	<table width = "650" align="center" style="background-color: transparent; background-position: top;">
		<tr align="center" style="background-color: transparent; background-position: center; font-size: 12px;">
		...
		<tr align="center" style="background-color: transparent; background-position: center; font-size: 14px;">
			<th colspan = "2"><br /><p style="font-weight: bold;">LỊCH CÔNG TÁC TUẦN</p>
		...
		<c:forEach var = "iterator" items="${ChiTietKHDT.noiDungChiTietKHDTModelList}">
			<c:if test="${iterator.tinhTrangPhanCong eq 1}">
				<c:if test = "${iterator.thu ne value}">
					<tr style="background-color: transparent; background-position: center; font-size: 14px;">
						<td colspan="2">
							<c:choose>
	...
	<table width = "900" align="center" style="background-color: transparent; background-position: top;">			
			<tr style="background-color: transparent; font-size: 14px;">
				<td colspan = "2">
					<b><u>Ghi chú</u> <p> ${sf:appendPTag(ChiTietKHDT.ghiChu)} </p></b>
				</td>
			</tr>						
	</table>
</table>

...
%>
	...
	function setTuan()
	{
		...
		<%if(keHoachDaoTaoModel.getTinhTrang() != null) {
			/*
			if(request.getParameter("msg") != null && request.getParameter("msg").equals("ThemDongTren")) {
				for(int i=0;i<namHocList.size();i++) {
					out.print("if(document.getElementById('txtNam3').value == '" + namHocList.get(i).getNamBatDau() + "'){");
					out.print("document.getElementById('txtNamHoc1').value = " + namHocList.get(i).getMaNamHoc() + ";}");
				}
				out.print("if(document.getElementById('txtNamHoc1').value == document.getElementById('txtNamHoc2').value) {");
				out.print("var kiTuTuan = document.getElementById('txtKiTuTuan2').value;");
				out.print("document.getElementById('td1').innerHTML = (parseInt(kiTuTuan) - 1);");
				out.print("document.getElementById('txtKiTuTuan1').value = (parseInt(kiTuTuan) - 1);");
				out.print("max = (parseInt(kiTuTuan) - 1); }");
				for(int i=0;i<tuanLeList.size();i++) {
					out.print("if(document.getElementById('txtNamHoc1').value == " + tuanLeList.get(i).getMaNamHoc() + ") {");
					out.print("if(kiTuTuan == '') {");
					out.print("if(max < " + Integer.parseInt(tuanLeList.get(i).getSoThuTu()) + ") {");
					out.print("document.getElementById('txtTuanLe1').value = " + tuanLeList.get(i).getMaTuanLe() + ";");
					out.print("document.getElementById('td1').innerHTML = " + tuanLeList.get(i).getSoThuTu() + ";");
					out.print("document.getElementById('txtKiTuTuan1').value = " + tuanLeList.get(i).getSoThuTu() + ";");
					...
					out.print("max = parseInt(document.getElementById('txtKiTuTuan1').value); } } ");
					out.print("else {");
					out.print("if(max == " + tuanLeList.get(i).getSoThuTu() + ") {");
					out.print("document.getElementById('txtTuNgay1').value = '" + tuanLeList.get(i).getTuNgay() + "';");
					out.print("document.getElementById('txtDenNgay1').value = '" + tuanLeList.get(i).getDenNgay() + "';");
					out.print("document.getElementById('txtTuanLe1').value = " + tuanLeList.get(i).getMaTuanLe() + "; } } }");
				}
			}
			if(request.getParameter("msg") != null && request.getParameter("msg").equals("ThemDongDuoi")) {
				out.print("document.getElementById('txtNamHoc" + Constant.NUM_ROWS + "').value = document.getElementById('txtNamHoc" + (Constant.NUM_ROWS-1) + "').value;");
				out.print("document.getElementById('td" + Constant.NUM_ROWS + "').innerHTML = (parseInt(document.getElementById('txtKiTuTuan" + (Constant.NUM_ROWS-1) + "').value) + 1);");
				out.print("document.getElementById('txtKiTuTuan" + Constant.NUM_ROWS + "').value = (parseInt(document.getElementById('txtKiTuTuan" + (Constant.NUM_ROWS-1) + "').value) + 1);");
				for(int i=0;i<tuanLeList.size();i++) {
					out.print("if(document.getElementById('txtNamHoc" + Constant.NUM_ROWS + "').value == " + tuanLeList.get(i).getMaNamHoc() + ") {");
					out.print("if(document.getElementById('txtKiTuTuan" + Constant.NUM_ROWS + "').value == " + tuanLeList.get(i).getSoThuTu() + "){");
					out.print("document.getElementById('txtTuanLe" + Constant.NUM_ROWS + "').value = " + tuanLeList.get(i).getMaTuanLe() + "; ");
					out.print("document.getElementById('txtTuNgay" + Constant.NUM_ROWS + "').value = '" + tuanLeList.get(i).getTuNgay() + "';");
					out.print("document.getElementById('txtDenNgay" + Constant.NUM_ROWS + "').value = '" + tuanLeList.get(i).getDenNgay() + "';}}");
				}
	...
	//	document.getElementById('txtKhoaA1').value = parseInt(document.getElementById('cboNam1').value) - 2 ;
	//	document.getElementById('txtKhoaA2').value = parseInt(document.getElementById('cboNam1').value) - 1;
	//	document.getElementById('txtKhoaB1').value = document.getElementById('cboNam1').value;
	//	document.getElementById('txtKhoaB2').value = parseInt(document.getElementById('cboNam1').value) + 1;
		if(tinhTrang != null)
			setTuan();
		pageLoad();		
	}
	...
	function themNguoi(boSung, iterator, khoaChinh, khoaPhu, maCongTac, objThucHien)
	{
		...
		for(var i=row;i<row + size;i++)
		{
			if(table.rows[i].innerHTML.match('MaCongTac-' + maCongTac + '-MaCongTac') != null)
			{
				...
				if((tinhTrang == <%=Constant.TINHTRANG_NEW %> || tinhTrang == <%=Constant.TINHTRANG_REJECT %> || (boSung == null && tinhTrang == <%=Constant.TINHTRANG_BO_SUNG %>)) && document.getElementById('txtDieuKien' + iterator).value == '0')
	...
	function themCongTac(iterator, khoaChinh, khoaPhu, objCongTac) 
	{
		...
		if(objCongTac.boSung != 0 && objCongTac.boSung != null) {
			table.rows[row].cells[--cell].innerHTML += "<br/><font color = 'blue'>Bổ sung lần " + objCongTac.boSung + "</font>";
			cell++;
		}
		table.rows[row].insertCell(cell++).innerHTML = "<input type = 'hidden' value = 'MaCongTac-" + objCongTac.maCongTac + "-MaCongTac'/>";
		if((tinhTrang == <%=Constant.TINHTRANG_NEW %> || tinhTrang == <%=Constant.TINHTRANG_REJECT %> || (objCongTac.boSung == null && tinhTrang == <%=Constant.TINHTRANG_BO_SUNG %>)) && document.getElementById('txtDieuKien' + iterator).value == '0') {
		...
		if((tinhTrang == <%=Constant.TINHTRANG_BO_SUNG %> && objCongTac.boSung != null && document.getElementById('txtDieuKien' + iterator).value == '0') || document.getElementById('txtDieuKien' + iterator).value == '1') 
...
<c:set var="KHDTObj" value="<%=keHoachDaoTaoModel %>" scope="session" ></c:set>
	...
	<div id = "div_border">
		...
		<c:forEach var="iterator" begin="1" end="<%=Constant.NUM_ROWS %>">
			<c:choose>	
			...
			<c:choose>				
					<c:when test="${((MaBoPhan ne BO_PHAN_PDT and MaBoPhan ne BO_PHAN_ADMIN and MaBoPhan ne BO_PHAN_PHC) 
							or KHDTObj.tinhTrang eq null 
								or KHDTObj.tinhTrang eq APPROVE 
									or KHDTObj.tinhTrang eq PENDING 
										or (KHDTObj.tinhTrang eq BOSUNG and SoSanhNgay eq true)) }"><!--
					...
					<c:otherwise>
						<c:choose>
							<c:when test = "${KHDTObj.tinhTrang ne BOSUNG}">
								<c:choose>
			...
			<tr style="background-color: transparent;">
				...
				<c:if test="${(KHDTObj.tinhTrang eq NEW 
								and ((MaBoPhan eq BO_PHAN_PDT and maThanhVien eq KHDTObj.maNguoiLap) or MaBoPhan eq BO_PHAN_ADMIN))
									or (KHDTObj.tinhTrang eq BOSUNG
										and (MaBoPhan eq BO_PHAN_PDT or MaBoPhan eq BO_PHAN_ADMIN or MaBoPhan eq BO_PHAN_PHC))}">
						<td>							
		...
		<c:if test="${((KHDTObj.tinhTrang eq NEW or KHDTObj.tinhTrang eq null)
								and ((MaBoPhan eq BO_PHAN_PDT and (maThanhVien eq KHDTObj.maNguoiLap or KHDT.obj eq null)) or MaBoPhan eq BO_PHAN_ADMIN))
									or (KHDTObj.tinhTrang eq BOSUNG
										and (MaBoPhan eq BO_PHAN_PDT or MaBoPhan eq BO_PHAN_ADMIN or MaBoPhan eq BO_PHAN_PHC))}">
		...
		<c:if test="${KHDTObj.tinhTrang eq APPROVE }">	
			...
			<c:if test="${MaBoPhan eq BO_PHAN_PDT
							or MaBoPhan eq BO_PHAN_ADMIN or MaBoPhan eq BO_PHAN_PHC}">
				<a href = "javascript: boSung()">
					<input type="hidden" name="BoSung" value = "" />
					<img src="<%=request.getContextPath()%>/images/buttom/bosung.png" alt="Bổ sung" border = "0" />
				</a>
			</c:if>
		</c:if>
		<c:if test="${KHDTObj.tinhTrang eq BOSUNG and (MaBoPhan eq BO_PHAN_PDT or MaBoPhan eq BO_PHAN_ADMIN or MaBoPhan eq BO_PHAN_PHC)}">
			<a href = "javascript: khongBoSung()">
				<input type="hidden" name="BoSung" value = "" />
				<img src="<%=request.getContextPath()%>/images/buttom/kobosung.png" alt="Không bổ sung" border = "0" />	
			</a>
		</c:if>

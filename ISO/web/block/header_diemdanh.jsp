...
<c:set var="sysRoleAppMenuList" value='<%= SysRoleMenuDAO.findSysRoleAppMenu(session.getAttribute("maBoPhan").toString(), Constant.APP_DIEMDANH) %>'></c:set>
...
<div class = "header">
  ...
  <div class="dock-container">
	<c:set var="chucNangMenu" value='<%= Constant.APP_DIEMDANH %>'></c:set>

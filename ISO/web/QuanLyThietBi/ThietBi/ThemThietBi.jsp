...
<c:set var='khoaList' value='<%=ThietBiDAO.showAllKhoa()%>'></c:set>
		...
		<table>
			<tr style="background-color: transparent;">
				...
				<table class="table1" width="500px" >
							...
							<td style="background-color: transparent;">
								<select id="selLoaiThietBi" name="selLoaiThietBi">
									...
									<c:forEach var="objLoaiThietBi" items="${loaiThietBiList}">
											<option value="${objLoaiThietBi.maLoaiThietBi}">${objLoaiThietBi.tenLoaiThietBi}</option>
									</c:forEach>
								</select>
							...
							<td>
								<select id="selDonViTinh" name="selDonViTinh">
									...
									<c:forEach var="objDonViTinh" items="${donViTinhList}">
											<option value="${objDonViTinh.maDonViTinh}">${objDonViTinh.tenDonViTinh}</option>
									</c:forEach>
								</select>
						...
						<tr>
							<td style="text-align:right">Ngày sản xuất</td><td><input type = "text" id="txtCalendar1" size = 8 name="txtCalendar1" style="background-color: transparent;"/>
						...
						<tr>
							...
							<td><input type = "text" id="txtCalendar2" size = 8 name="txtCalendar2" style="background-color: transparent;"/>
						...
						<tr>
							<td style="text-align:right">Ngày bảo hành</td><td><input type = "text" id="txtCalendar3" size = 8 name="txtCalendar3" style="background-color: transparent;"/>
				...
				<table border="1"  id="frmChiTietThietBi" class="table3">
					...
					<tr>
						<td colspan="5">
							<a href = "javascript: click_btnThemDong()">

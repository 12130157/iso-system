		...
		<table>
			...
			<table border="1" style="background-color: :transparent;">
				<tr>
					...
					<th style='background-color: #186fb2;color:white'>Chi tiết</th>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="7">
						<a><img src="<%=request.getContextPath()%>/images/buttom/tra.png" alt="Trả Thiết Bị" border = "0" /></a>
					
						<a><img src="<%=request.getContextPath()%>/images/buttom/guiemailnhacnho.png" alt="Gửi email" border = "0" /></a>
					</td>
				</tr>
			</table>	
		</div>

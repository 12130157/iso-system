...
public class TanSuatModel {
	private String maTanSuat;
	private String tenTanSuat;
	...
	public String getMaTanSuat(){
		return this.maTanSuat;
	}
	public void setMaTanSuat(String maTanSuat){
		this.maTanSuat=maTanSuat;
	}
	
	public String getTenTanSuat(){
		return this.tenTanSuat;
	}
	public void setTenTanSuat(String tenTanSuat){
		this.tenTanSuat=tenTanSuat;
	}

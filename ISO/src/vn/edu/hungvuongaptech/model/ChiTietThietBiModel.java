...
public class ChiTietThietBiModel implements Serializable{
	private static final long serialVersionUID = 1L;
	private String maChiTietThietBi;
	private String maThietBi;
	private String tenChiTietThietBi;
	private String maLoaiChiTietThietBi;
	private String tenLoaiChiTietThietBi;
	...
	public void setMaChiTietThietBi(String maChiTietThietBi) {
		this.maChiTietThietBi = maChiTietThietBi;
	}
	public String getTenChiTietThietBi() {
		return tenChiTietThietBi;
	}
	public void setTenChiTietThietBi(String tenChiTietThietBi) {
		this.tenChiTietThietBi = tenChiTietThietBi;
	}
	public String getMaLoaiChiTietThietBi() {
		return maLoaiChiTietThietBi;
	}
	public void setMaLoaiChiTietThietBi(String maLoaiChiTietThietBi) {
		this.maLoaiChiTietThietBi = maLoaiChiTietThietBi;
	}
	public String getTenLoaiChiTietThietBi() {
		return tenLoaiChiTietThietBi;
	}
	public void setTenLoaiChiTietThietBi(String tenLoaiChiTietThietBi) {
		this.tenLoaiChiTietThietBi = tenLoaiChiTietThietBi;
	}
	...
	public String getMaChiThietThietBiTruoc() {
		return maChiThietThietBiTruoc;
	}
	public void setMaChiThietThietBiTruoc(String maChiThietThietBiTruoc) {
		this.maChiThietThietBiTruoc = maChiThietThietBiTruoc;
	}
	...
	private String maChiThietThietBiTruoc;
	...
	// xai cho them chi tiet thiet bi
	private String tenThietBi;
	private String kiHieuThietBi;
	...
	public String getKiHieuThietBi() {
		return kiHieuThietBi;
	}
	public void setKiHieuThietBi(String kiHieuThietBi) {
		this.kiHieuThietBi = kiHieuThietBi;
	}

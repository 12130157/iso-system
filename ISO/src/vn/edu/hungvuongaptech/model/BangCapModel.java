...
public class BangCapModel {
	...
	public void setNgachLuong(String ngachLuong) {
		this.ngachLuong = ngachLuong;
	}
	public String getBangCapChinh() {
		return bangCapChinh;
	}
	public void setBangCapChinh(String bangCapChinh) {
		this.bangCapChinh = bangCapChinh;
	}
	public String getId() {
		return id;
	}

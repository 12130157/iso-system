...
/* ---------------------------------------------------------------------- */
/* Add table "LopNganHan"                                                 */
/* ---------------------------------------------------------------------- */

CREATE TABLE [LopNganHan] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ma_KhoaTT] INTEGER,
    [Ten_Lop] VARCHAR(200),
    [Ghi_Chu] VARCHAR(500),
    ...
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_LopNganHan] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "HinhThucLop"                                                */
/* ---------------------------------------------------------------------- */

CREATE TABLE [HinhThucLop] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ten_Hinh_Thuc] VARCHAR(200),
    [Ghi_Chu] VARCHAR(500),
    [User1] VARCHAR(40),
    [User2] VARCHAR(40),
    [User3] VARCHAR(40),
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_HinhThucLop] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "MonHocNganHan"                                              */
/* ---------------------------------------------------------------------- */

CREATE TABLE [MonHocNganHan] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ma_Lop_Ngan_Han] INTEGER,
    [Ma_Hinh_Thuc_Lop] INTEGER,
    [Ten_Mon_Hoc] VARCHAR(200),
    [Thoi_Gian_Hoc] INTEGER,
    [Hoc_Phi] DOUBLE PRECISION,
    [Dieu_Kien_Hoc] VARCHAR(100),
    [Ghi_Chu] VARCHAR(500),
    [User1] VARCHAR(40),
    [User2] VARCHAR(40),
    [User3] VARCHAR(40),
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_MonHocNganHan] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "LichKhaiGiang"                                              */
/* ---------------------------------------------------------------------- */
...
CREATE TABLE [LichKhaiGiang] (
    ...
    [Ngay_Bat_Dau] DATETIME,
    [Buoi] VARCHAR(40),
    [Thu_Trong_Tuan] VARCHAR(40),
    [Gio_Bat_Dau] VARCHAR(40),
    [Gio_Ket_Thuc] VARCHAR(40),
    [Ma_Giao_Vien] INTEGER,
    [Ghi_Chu] VARCHAR(40),
    [User1] VARCHAR(40),
    [User2] VARCHAR(40),
    ...
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_LichKhaiGiang] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "HocVienNganHan"                                             */
/* ---------------------------------------------------------------------- */

CREATE TABLE [HocVienNganHan] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ma_Lich_Khai_Giang] INTEGER,
    [Ho] VARCHAR(40),
    [Ten_Lot] VARCHAR(40),
    [Ten] VARCHAR(40),
    ...
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_HocVienNganHan] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "DanhBaHVNganHan"                                            */
/* ---------------------------------------------------------------------- */

CREATE TABLE [DanhBaHVNganHan] (
    [Ma_Hoc_Vien_Ngan_Han] INTEGER NOT NULL,
    [Ma_Loai_Tai_Khoan] INTEGER NOT NULL,
    [Ten_HVNH] VARCHAR(100),
    [So_Dien_Thoai] VARCHAR(40),
    [User1] VARCHAR(40),
    [User2] VARCHAR(40),
    [User3] VARCHAR(40),
    [User4] VARCHAR(40),
    [User5] VARCHAR(40),
    CONSTRAINT [PK_DanhBaHVNganHan] PRIMARY KEY ([Ma_Hoc_Vien_Ngan_Han])
)
GO
...
CREATE TABLE [ToTrinh] (
    ...
    [User4] NVARCHAR(40),
    [User5] NVARCHAR(40),
    CONSTRAINT [PK_ToTrinh] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "MonHocTKBThayDoi"                                           */
/* ---------------------------------------------------------------------- */

CREATE TABLE [MonHocTKBThayDoi] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ma_mon_hoc_TKB] INTEGER,
    [Ma_giao_vien] INTEGER,
    [Ma_to_trinh] INTEGER,
    ...
    [User4] NVARCHAR(40),
    [User5] NVARCHAR(40),
    CONSTRAINT [PK_MonHocTKBThayDoi] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "ChiTietTKBThayDoi"                                          */
/* ---------------------------------------------------------------------- */

CREATE TABLE [ChiTietTKBThayDoi] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ma_mon_hoc_TKB] INTEGER,
    [Ma_chi_tiet_TKB] INTEGER,
    [Thu_trong_tuan] INTEGER,
    [Buoi] NVARCHAR(10),
    [Ma_phong] INTEGER,
    [Tuan] INTEGER,
    ...
    [User4] NVARCHAR(40),
    [User5] NVARCHAR(40),
    CONSTRAINT [PK_ChiTietTKBThayDoi] PRIMARY KEY ([ID])
)
GO

/* ---------------------------------------------------------------------- */
/* Add table "HienTrangThietBi"                                           */
/* ---------------------------------------------------------------------- */

CREATE TABLE [HienTrangThietBi] (
    [ID] INTEGER IDENTITY(0,1) NOT NULL,
    [Ten] NVARCHAR(40),
    [Ghi_chu] NVARCHAR(100),
    [Ngay_cap_nhat_cuoi] DATETIME,
    ...
    [User4] NVARCHAR(40),
    [User5] NVARCHAR(40),
    CONSTRAINT [PK_HienTrangThietBi] PRIMARY KEY ([ID])
)
GO
...
ALTER TABLE [MonHocNganHan] ADD CONSTRAINT [LopNganHan_MonHocNganHan] 
    FOREIGN KEY ([Ma_Lop_Ngan_Han]) REFERENCES [LopNganHan] ([ID])
GO

ALTER TABLE [MonHocNganHan] ADD CONSTRAINT [HinhThucLop_MonHocNganHan] 
    FOREIGN KEY ([Ma_Hinh_Thuc_Lop]) REFERENCES [HinhThucLop] ([ID])
GO

ALTER TABLE [LichKhaiGiang] ADD CONSTRAINT [MonHocNganHan_LichKhaiGiang] 
    FOREIGN KEY ([Ma_Mon_Hoc]) REFERENCES [MonHocNganHan] ([ID])
GO

ALTER TABLE [HocVienNganHan] ADD CONSTRAINT [LichKhaiGiang_HocVienNganHan] 
    FOREIGN KEY ([Ma_Lich_Khai_Giang]) REFERENCES [LichKhaiGiang] ([ID])
GO

ALTER TABLE [DanhBaHVNganHan] ADD CONSTRAINT [LoaiTaiKhoanSMS_DanhBaHVNganHan] 
    FOREIGN KEY ([Ma_Loai_Tai_Khoan]) REFERENCES [LoaiTaiKhoanSMS] ([ID])
GO

...
<div align="center">
	...
	<!-- E HEAD CONTENT -->
	<c:set var="tenApp" value='<%=SysRoleMenuDAO.getSysMenuByMenuID(request.getParameter("menuID"))%>'></c:set>	
	<c:set var="listPhanQuyen" value='<%=SysRoleMenuDAO.getVaiTroMenuDaPhanQuyen(request.getParameter("menuID"))%>'></c:set>
	<c:set var="listChuaPhanQuyen" value='<%=SysRoleMenuDAO.getVaiTroMenuChuaPhanQuyen(request.getParameter("menuID"))%>'></c:set>
	
	<br/><br/><br/><br/><br/>
	
	<b>Bạn đang chọn <u>vai trò</u> cho chức năng <u>${tenApp.menuName}</u></b>
	<form method="post" action="<%=request.getContextPath()%>/AdminController?actionType=PhanQuyenMenu&actionStatus=huy&menuID=${param.menuID}" name="ActionPhanQuyen" id="ActionPhanQuyen" enctype="application/x-www-form-urlencoded">	
			<table>
			<tr>
			<td>
			...
			<br/>
	<form action="<%=request.getContextPath()%>/AdminController?actionType=PhanQuyenMenu&actionStatus=huyAll&menuID=${param.menuID}"  method="post" name="ActionPhanQuyenAll" enctype="application/x-www-form-urlencoded">
	...
	<form action="<%=request.getContextPath()%>/AdminController?actionType=PhanQuyenMenu&actionStatus=them&menuID=${param.menuID}" name="ActionChuaPhanQuyen" id="ActionChuaPhanQuyen" method="post" enctype="application/x-www-form-urlencoded">
	...
	<tr>
		<td></td>
		<td><form action="<%=request.getContextPath()%>/AdminController?actionType=PhanQuyenMenu&actionStatus=themAll&menuID=${param.menuID}" name="ActionChuaPhanQuyenAll" id="ActionChuaPhanQuyenAll" method="post" enctype="application/x-www-form-urlencoded">

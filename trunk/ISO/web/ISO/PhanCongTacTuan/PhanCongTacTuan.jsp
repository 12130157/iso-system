			...
			if(chiTietKHDTModel.getNoiDungChiTietKHDTModelList() != null) {
				...
				for(int i=0;i<noiDungList.size();i++) {
					...
					if(noiDungList.get(i).getGhiChu() != null && !noiDungList.get(i).getGhiChu().equals("")) {
						noiDungList.get(i).setGhiChu(noiDungList.get(i).getGhiChu().replaceAll("'","-DAUNHAY-"));
						noiDungList.get(i).setGhiChu(noiDungList.get(i).getGhiChu().replaceAll("\"","-DAUNHAY1-"));
						...
						out.print("document.getElementById('txt' + obj.id).value = document.getElementById('txt' + obj.id).value.replace(/-DAUNHAY-/gi, dauNhay);");
						out.print("document.getElementById('txt' + obj.id).value = document.getElementById('txt' + obj.id).value.replace(/-DAUNHAY1-/gi, dauNhay1);");
					}
					out.print("}");
				}
			}

...
<%@ taglib prefix="d" uri="http://weblib.kth.taglib" %>
...
<d:authorize_role pathTo="/WEB-INF/authorize.xml" request="${pageContext.request}" response="${pageContext.response}"></d:authorize_role>

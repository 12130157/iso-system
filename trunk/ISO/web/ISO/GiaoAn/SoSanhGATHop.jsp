...
<c:set var="giaoAnSoSanh" value='<%=GiaoAnDAO.getGiaoAnTichHopByMaGA(request.getParameter("maGA"))%>' ></c:set>		
...
<table width="100%" height="100%" bgcolor="#808080" align="center" style="background-image: url('<%=request.getContextPath()%>/images/background_print.jpg');padding-left : 15px;padding-right : 15px;">
	<tr><td>
		...
		<table width = "700px" align="center" style="background-color: transparent;">
			...
			<tr style="background-color: transparent;">
				<td colspan = "2">		
					<div style="padding-left:40px">${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.onDinhLH))}
					</div>
					<div style="padding-left:40px;background-color:yellow">${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.onDinhLH))}
					</div>
				</td>
			</tr>
			<tr style="background-color: transparent;">
		...
		<table border = "1" width="650px" style="background-color: transparent;">
			...
			<tr style="background-color: transparent;">
				...
				<td>
					...
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDDanNhapGV))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDDanNhapHS))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDDanNhapHS))}</p>
				</td>
				<td align='center'>
			...
			<tr>
				...
				<td>Giới thiệu chủ đề : <br />
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.gioiThieuChuDe))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.gioiThieuChuDe))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDGTCDGV))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDGTCDGV))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDGTCDHS))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDGTCDHS))}</p>
				</td>
				<td align='center'>
					${giaoAnLyThuyet.thoiGianGTCD}
					<p style='background-color:yellow'>${giaoAnSoSanh.thoiGianGTCD}</p>
				</td>
			</tr>
			<tr>
				<td align='center'>3</td>
				<td>Giải quyết vấn đề : <br />
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.giaiQuyetVanDe))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.giaiQuyetVanDe))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDGQVDGV))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDGQVDGV))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDGQVDHS))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDGQVDHS))}</p>
				</td>
				<td align='center'>
					${giaoAnLyThuyet.thoiGianGTVD}
					<p style='background-color:yellow'>${giaoAnSoSanh.thoiGianGTVD}</p>
				</td>
			</tr>
			<tr>
				...
				<td>Kết thúc vấn đề: <br />
					...
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.huongDanKetThuc))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDHDKTGV))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDHDKTGV))}</p>
				</td>
				<td>
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDHDKTHS))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDHDKTHS))}</p>
				</td>
				<td align='center'>
					${giaoAnLyThuyet.thoiGianHDKT}
					<p style='background-color:yellow'>${giaoAnSoSanh.thoiGianHDKT}</p>
				</td>
			</tr>
			<tr>
				...
				<td>Hướng dẫn tự học : <br />
					...
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.huongDanTuHoc))}</p>
				</td>
				<td colspan="2">
					${sf:appendBrTag3(sf:appendBrTag2(giaoAnLyThuyet.HDHDTHGV))}
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.HDHDTHGV))}</p>
				</td>
				<td align='center'>
					${giaoAnLyThuyet.thoiGianHDTH}
					<p style='background-color:yellow'>${giaoAnSoSanh.thoiGianHDTH}</p>
				</td>
			</tr>
		</table>
		<table style="background-color: transparent;">
			...
			<tr>
				<td>
					...
					<p style='background-color:yellow'>${sf:appendBrTag3(sf:appendBrTag2(giaoAnSoSanh.rutKinhNghiem))}</p>
				</td>
			</tr>
		</table>
		</div>
		<table style="background-color: transparent;width:750px;padding-right:100px">
			...
			<tr style="background-color: transparent;">
				...
				<p style='background-color:yellow'>${objKHGDSS.tenTruongKhoa}</p>
				</td>
				<td align='center'><br/><br/><br/><br/><br/><br/>${objKHGD.tenGiaoVien}
				<p style='background-color:yellow'>${objKHGDSS.tenGiaoVien}</p>
				</td>
			</tr>
		</table>
	</td></tr>	

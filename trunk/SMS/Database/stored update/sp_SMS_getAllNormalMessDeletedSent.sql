...
*/
IF EXISTS ( SELECT * FROM SYSOBJECTS WHERE NAME = 'sp_SMS_getAllNormalMessDeletedSent') 
BEGIN
	DROP PROC sp_SMS_getAllNormalMessDeletedSent
END
GO
CREATE PROC sp_SMS_getAllNormalMessDeletedSent
AS
BEGIN

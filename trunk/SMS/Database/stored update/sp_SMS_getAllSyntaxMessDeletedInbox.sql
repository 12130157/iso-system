...
*/
IF EXISTS ( SELECT * FROM SYSOBJECTS WHERE NAME = 'sp_SMS_getAllSyntaxMessDeletedInbox') 
BEGIN
	DROP PROC sp_SMS_getAllSyntaxMessDeletedInbox
END
GO
CREATE PROC sp_SMS_getAllSyntaxMessDeletedInbox
AS
BEGIN

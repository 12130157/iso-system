...
*/
IF EXISTS ( SELECT * FROM SYSOBJECTS WHERE NAME = 'sp_SMS_getAllSyntaxMessInbox') 
BEGIN
	DROP PROC sp_SMS_getAllSyntaxMessInbox
END
GO
CREATE PROC sp_SMS_getAllSyntaxMessInbox
AS
BEGIN

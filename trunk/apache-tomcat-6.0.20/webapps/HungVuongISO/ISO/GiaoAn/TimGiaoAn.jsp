...
<div class = "div_pagebody">
	...
	<table class="tblTimKiem">
		<tr><td style='color:blue;text-align:left' colspan="7" >Thông tin tìm kiếm</td></tr>
		<tr>
			<td>Khoa</td>
		...
		<tr><td colspan="7" style="text-align:right"><input type="button" value="Tìm kiếm" onclick="click_btnTim()"/></td></tr>	
	...
	<table border="1">
		<tr><td style='color:blue;text-align:center' colspan="9">Kết quả tìm kiếm</td></tr>
		<tr>
	...
	<table>
		<tr><td style="color:blue;text-align:left" >Chức năng</td></tr>
		<tr><td><input type='button' value='In kết quả'/></td></tr>
	</table>
	</form>
	<!-- S FOOT CONTENT -->
...
<% GiaoAnDAO.dropTableKetQuaTimGiaoAn(); %>
</body>
</html>
...
function loadPage() 
{
	<%
		...
		if(request.getParameter("Them")== null || request.getParameter("maID") != null) {
			for(int i=0;i<chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().size();i++)
			{
				out.print("if(" + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getMaHocPhan() + "== 1){");
				out.print("if(" + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getNamHoc() + "!= 0){");
				out.print("document.getElementById('NamHoc_PhanI_' + count1).value = " + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getNamHoc() + ";");
				out.print("selectNamHoc('I',count1);}");
				out.print("document.getElementById('HocKi_PhanI_' + count1).value = " + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getHocKi() + ";");
				out.print("count1++; }");
				
				out.print("else if(" + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getMaHocPhan() + "== 2){");
				out.print("if(" + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getNamHoc() + "!= 0){");
				out.print("document.getElementById('NamHoc_PhanII_' + count2).value = " + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getNamHoc() + ";");
				out.print("selectNamHoc('II',count2);}");
				out.print("document.getElementById('HocKi_PhanII_' + count2).value = " + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getHocKi() + ";");
				out.print("count2++; }");
				
				out.print("else if(" + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getMaHocPhan() + "== 3){");
				out.print("if(" + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getNamHoc() + "!= 0){");
				out.print("document.getElementById('NamHoc_PhanIII_' + count3).value = " + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getNamHoc() + ";");
				out.print("selectNamHoc('III',count3);}");
				out.print("document.getElementById('HocKi_PhanIII_' + count3).value = " + chuongTrinhDaoTaoModel.getChiTietMonHocCTDTModelList().get(i).getHocKi() + ";");
				out.print("count3++; }");
			}
		}
...
{	
	...
	if(x != '') {	
		<%/* 	
		if(chuongTrinhDaoTaoModel.getMaChuongTrinhDaoTao() != null || chuongTrinhDaoTaoModel.getMaChuongTrinhDaoTao() != "") {
			out.print("var opt = new Option('" + chuongTrinhDaoTaoModel.getTenNghe() + "', '" + chuongTrinhDaoTaoModel.getMaNghe() + "');");
...
function selectHeDaoTao(maTrinhDo)
{
	...
	for(Integer i=1; i<=Constant.NUM_ROWS_PHAN_1;i++)
	{
		out.print("document.getElementById('NamHoc_PhanI_" + i.toString() + "').innerHTML = null;");
		out.print("for(var i =1;i<=document.getElementById('ThoiGianDaoTao').value;i++)");
		out.print("{ var opt = new Option(i,i);");
		out.print("document.getElementById('NamHoc_PhanI_" + i.toString() +"').add(opt,undefined);}");
		out.print("selectNamHoc('I'," + i.toString() +");");
	}
	
	for(Integer i=1; i<=Constant.NUM_ROWS_PHAN_2;i++)
	{
		out.print("document.getElementById('NamHoc_PhanII_" + i.toString() + "').innerHTML = null;");
		out.print("for(var i =1;i<=document.getElementById('ThoiGianDaoTao').value;i++)");
		out.print("{ var opt = new Option(i,i);");
		out.print("document.getElementById('NamHoc_PhanII_" + i.toString() +"').add(opt,undefined);}");
		out.print("selectNamHoc('II'," + i.toString() +");");
	}
	
	for(Integer i=1; i<=Constant.NUM_ROWS_PHAN_3;i++)
	{
		out.print("document.getElementById('NamHoc_PhanIII_" + i.toString() + "').innerHTML = null;");
		out.print("for(var i =1;i<=document.getElementById('ThoiGianDaoTao').value;i++)");
		out.print("{ var opt = new Option(i,i);");
		out.print("document.getElementById('NamHoc_PhanIII_" + i.toString() +"').add(opt,undefined);}");
		out.print("selectNamHoc('III'," + i.toString() +");");
	}
...
function selectCheckboxAll(x) {
		if(x == 1)
		{
			if(document.CTDT.chkAllRow_PhanI.checked == true)
			{
				...
				for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_1;i++)
				{
					out.print("document.CTDT.chkRow_PhanI_" + i.toString() + ".checked = true;\n");
				}
				%>
			}
			else
			{
				...
				for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_1;i++)
				{
					out.print("document.CTDT.chkRow_PhanI_" + i.toString() + ".checked = false;\n");
				}
				%>
			}			
		}	
		else if(x == 2)
		{
			if(document.CTDT.chkAllRow_PhanII.checked == true)
			{
				...
				for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_2;i++)
				{
					out.print("document.CTDT.chkRow_PhanII_" + i.toString() + ".checked = true;\n");
				}
				%>
			}
			else
			{
				...
				for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_2;i++)
				{
					out.print("document.CTDT.chkRow_PhanII_" + i.toString() + ".checked = false;\n");
				}
				%>
			}			
		}
			...
			if(document.CTDT.chkAllRow_PhanIII.checked == true)
			{
				...
				for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_3;i++)
				{
					out.print("document.CTDT.chkRow_PhanIII_" + i.toString() + ".checked = true;\n");
				}
				%>
			}
			else
			{
				...
				for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_3;i++)
				{
					out.print("document.CTDT.chkRow_PhanIII_" + i.toString() + ".checked = false;\n");
				}
				%>
			}			
		}
}
function selectCheckboxRow(x) {
	if(x == 1)
	{
		if (document.CTDT.chkAllRow_PhanI.checked == true)
...
function selectSogio(x) {
	if(x == 1)
	{
		...
		for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_1;i++)
		{
			out.print("var a = parseInt(document.getElementById('LyThuyet_PhanI_" + i.toString() +"').value);");
			out.print("tongLT += a;");
			out.print("document.getElementById('TongSoLyThuyet_PhanI').value = tongLT;");
			
			out.print("var b = parseInt(document.getElementById('ThucHanh_PhanI_" + i.toString() +"').value);");
			out.print("tongTH += b;");
			out.print("document.getElementById('TongSoThucHanh_PhanI').value = tongTH;");
			out.print("document.getElementById('TongSo_PhanI_" + i.toString() + "').value = a + b;");
		}
		%>
	...
	else if(x == 2)
	{
		...
		for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_2;i++)
		{
			out.print("var a = parseInt(document.getElementById('LyThuyet_PhanII_" + i.toString() +"').value);");
			out.print("tongLT += a;");
			out.print("document.getElementById('TongSoLyThuyet_PhanII').value = tongLT;");
			
			out.print("var b = parseInt(document.getElementById('ThucHanh_PhanII_" + i.toString() +"').value);");
			out.print("tongTH += b;");
			out.print("document.getElementById('TongSoThucHanh_PhanII').value = tongTH;");
			out.print("document.getElementById('TongSo_PhanII_" + i.toString() + "').value = a + b;");
		}
		%>
	...
	else if(x == 3)
	{
		...
		for(Integer i=1;i<=Constant.NUM_ROWS_PHAN_3;i++)
		{
			out.print("var a = parseInt(document.getElementById('LyThuyet_PhanIII_" + i.toString() +"').value);");
			out.print("tongLT += a;");
			out.print("document.getElementById('TongSoLyThuyet_PhanIII').value = tongLT;");
			
			out.print("var b = parseInt(document.getElementById('ThucHanh_PhanIII_" + i.toString() +"').value);");
			out.print("tongTH += b;");
			out.print("document.getElementById('TongSoThucHanh_PhanIII').value = tongTH;");
			out.print("document.getElementById('TongSo_PhanIII_" + i.toString() + "').value = a + b;");
		}
		%>
...
function confirmDeleteRow(x) {
	...
	if(x == 1)
	{
		...
		<%
		for(Integer i = 1; i<= Constant.NUM_ROWS_PHAN_1; i++) {
	 		out.write("if(document.CTDT.chkRow_PhanI_" + i.toString() +".checked == true){\n");
	 		out.print("check = '1';");
	 		out.write("msg += ' " + i.toString() + " - '; } \n");
	 	}
		out.write("msg += 'của các môn học chung';");
		%>
	} else if(x == 2)
	{
		...
		<%
		for(Integer i = 1; i<= Constant.NUM_ROWS_PHAN_2; i++) {
	 		out.write("if(document.CTDT.chkRow_PhanII_" + i.toString() +".checked == true){\n");
	 		out.print("check = '1';");
	 		out.write("msg += ' " + i.toString() + " - '; } \n");
	 	}
		out.write("msg += 'của các môn học cơ sở';");
		%>
	} else 
	{
		...
		<%
		for(Integer i = 1; i<= Constant.NUM_ROWS_PHAN_3; i++) {
	 		out.write("if(document.CTDT.chkRow_PhanIII_" + i.toString() +".checked == true){\n");
	 		out.print("check = '1';");
	 		out.write("msg += ' " + i.toString() + " - '; } \n");
	 	}
		out.write("msg += 'của các môn học chuyên ngành';");
		%>
	}
	<%		
 	out.write("if(check == '') {\n");
...
<table border = "1" width = "800" style="background-color: transparent;">
	...
	<tr style="background-color: transparent;">
		<td>&nbsp;</td>
		<td><input type = "checkbox" name="chkAllRow_PhanI" onclick="selectCheckboxAll(1);"></input></td>
		<td>I</td>
	...
	<% int num = 0; %>
<c:forEach var = "count" begin = "1" end = "<%=Constant.NUM_ROWS_PHAN_1 %>" step = "1">
	<c:set var="ChiTietCTDT" value="${ChuongTrinhDaoTao.chiTietMonHocCTDTModelList[count-1]}"></c:set>
	<tr style="background-color: transparent;">
		<td><input type="checkbox" name = "TinhTrangMonHoc_PhanI_${count}"
			<c:if test="${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 1}">checked</c:if> disabled="disabled"/>
			<input type="hidden" name="MaDeCuong_PhanI_${count}" 			
				<c:choose>	
					<c:when test="${ChiTietCTDT.maHocPhan eq 1}">
						value="${ChiTietCTDT.maDeCuong}"
					</c:when>
					<c:otherwise>
						value="-1"
					</c:otherwise>
			...
			/>
			<input type="hidden" name="TinhTrang_PhanI_${count}" 
					<c:if test="${ChiTietCTDT.maHocPhan eq 1}">
						value="${ChiTietCTDT.tinhTrang}"
					</c:if>
			/>
			<input type="hidden" name="MaNguoiTaoDeCuong_PhanI_${count}" 
					<c:if test="${ChiTietCTDT.maHocPhan eq 1}">
						value="${ChiTietCTDT.maNguoiTaoDeCuong}"
					</c:if>
			/>
		</td>
		<td><input type = "checkbox" name = "chkRow_PhanI_${count}" onclick="selectCheckboxRow(1);"></input></td>
		<td>${count}.</td>
		<td>
			<select <c:if test = "${ChiTietCTDT.tinhTrang ne null and ChiTietCTDT.tinhTrang ne '' and ChiTietCTDT.maHocPhan eq 1}">disabled</c:if>
				id = "MonHoc_PhanI_${count}" name="cboMonHoc_PhanI_${count}" onclick="selectMonHoc('I','${count}');">
				<option value = "">--Select--</option>
				<c:forEach var = "MonHocObj" items="${ListMonHoc}">
					<option value = "${MonHocObj.maMonHoc}" <c:if test="${ChiTietCTDT.maMonHoc eq MonHocObj.maMonHoc and ChiTietCTDT.maHocPhan eq 1}">selected</c:if>>${MonHocObj.tenMonHoc}</option>
				</c:forEach>
			</select>
			<c:if test="${(not empty ChiTietCTDT.maDeCuong and ChiTietCTDT.maDeCuong ne -1) and ChiTietCTDT.tinhTrang ne null and ChiTietCTDT.tinhTrang ne NEW and ChiTietCTDT.maHocPhan eq 1}">	
				<a href="<%=request.getContextPath()%>/ISO/DeCuongMonHoc/DeCuong.jsp?maID=${ChiTietCTDT.maDeCuong}">Xem chi tiết</a>
			</c:if>
			<c:if test="${not empty param.errTrungMonHoc and ChiTietCTDT.maMonHoc ne '' and ChiTietCTDT.maHocPhan eq 1 and ChiTietCTDT.kiemTraTrung eq 1}"><b class="error">(X)</b></c:if>
			<c:if test="${not empty param.err and ChiTietCTDT.maMonHoc eq '' and ChiTietCTDT.maHocPhan eq 1}"><b class="error">(*)</b></c:if>
		</td>
		...
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 1}">disabled</c:if> 
			...
			<c:forEach var = "iterator" begin = "1" end = "200">
				<option value = "${iterator }" <c:if test = "${ChiTietCTDT.lyThuyet eq iterator and ChiTietCTDT.maHocPhan eq 1}">selected</c:if>>${iterator}</option>
			</c:forEach>
		</select></td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 1}">disabled</c:if> 
			...
			<option value = "0">0</option>
			<c:forEach var = "iterator" begin = "1" end = "200">
				<option value = "${iterator }" <c:if test = "${ChiTietCTDT.thucHanh eq iterator and ChiTietCTDT.maHocPhan eq 1}">selected</c:if>>${iterator}</option>
			</c:forEach>
		</select></td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 1}">disabled</c:if> 
				id = "TinhChat_PhanI_${count}" name="cboTinhChat_PhanI_${count}">
			<option value = "Thi" <c:if test="${ChiTietCTDT.tinhChat eq 'Thi'and ChiTietCTDT.maHocPhan eq 1}">selected</c:if>>Thi</option>
			<option value = "Kiểm tra" <c:if test="${ChiTietCTDT.tinhChat eq 'Kiểm tra' and ChiTietCTDT.maHocPhan eq 1}">selected</c:if>>Kiểm tra</option>
			<option value = "Báo cáo" <c:if test="${ChiTietCTDT.tinhChat eq 'Báo cáo' and ChiTietCTDT.maHocPhan eq 1}">selected</c:if>>Báo cáo</option>
		</select></td>
	</tr>
	<c:if test="${ChiTietCTDT.maHocPhan eq 1}">
		<% num++; %>
	...
	<tr style="background-color: transparent;">
					...
					<c:when test="${ChuongTrinhDaoTao.tinhTrang eq NEW or ChuongTrinhDaoTao.tinhTrang eq REJECT or ChuongTrinhDaoTao.tinhTrang eq null}">			
						<td colspan = 12>							
							<a href = "javascript: addRow(1)">
								<input type="hidden" name="XuLyDong_Phan1" id="XuLyDong" /> 
	 ...
	 <tr style="background-color: transparent;">
	 	<td>&nbsp;</td>
	 	<td><input type = "checkbox" name="chkAllRow_PhanII" onclick="selectCheckboxAll(2);"></input></td>
		<td>II</td>
	...
	<c:forEach var = "count" begin = "1" end = "<%=Constant.NUM_ROWS_PHAN_2 %>" step = "1">
		<c:set var="ChiTietCTDT" value="${ChuongTrinhDaoTao.chiTietMonHocCTDTModelList[count+num-1]}"></c:set>
	<tr style="background-color: transparent;">
		<td><input type="checkbox" name = "TinhTrangMonHoc_PhanII_${count}"
			<c:if test="${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 2}">checked</c:if> disabled="disabled"/>
			<input type="hidden" name="MaDeCuong_PhanII_${count}" 		
				<c:choose>	
					<c:when test="${ChiTietCTDT.maHocPhan eq 2}">
						value="${ChiTietCTDT.maDeCuong}"
					</c:when>
					<c:otherwise>
						value="-1"
			...
			/>
			<input type="hidden" name="TinhTrang_PhanII_${count}" 
					<c:if test="${ChiTietCTDT.maHocPhan eq 2}">
						value="${ChiTietCTDT.tinhTrang}"
					</c:if>
			/>
			<input type="hidden" name="MaNguoiTaoDeCuong_PhanII_${count}" 
					<c:if test="${ChiTietCTDT.maHocPhan eq 2}">
						value="${ChiTietCTDT.maNguoiTaoDeCuong}"
					</c:if>
			/>
		</td>
		<td><input type = "checkbox" name = "chkRow_PhanII_${count}" onclick="selectCheckboxRow(2);"></input></td>
		<td>${count}.</td>
		<td>
			<select <c:if test = "${ChiTietCTDT.tinhTrang ne null and ChiTietCTDT.tinhTrang ne '' and ChiTietCTDT.maHocPhan eq 2}">disabled</c:if>
				id = "MonHoc_PhanII_${count}" name = "cboMonHoc_PhanII_${count}" onclick="selectMonHoc('II','${count}');">
				<option value="">--Select--</option>
				<c:forEach var = "MonHocObj" items="${ListMonHoc}">
					<option value = "${MonHocObj.maMonHoc}" <c:if test="${ChiTietCTDT.maMonHoc eq MonHocObj.maMonHoc and ChiTietCTDT.maHocPhan eq 2}">selected</c:if>>${MonHocObj.tenMonHoc}</option>
				</c:forEach>
			</select>
			<c:if test="${(not empty ChiTietCTDT.maDeCuong and ChiTietCTDT.maDeCuong ne -1) and ChiTietCTDT.tinhTrang ne null and ChiTietCTDT.tinhTrang ne NEW and ChiTietCTDT.maHocPhan eq 2}">	
				<a href="<%=request.getContextPath()%>/ISO/DeCuongMonHoc/DeCuong.jsp?maID=${ChiTietCTDT.maDeCuong}">Xem chi tiết</a>
			</c:if>
			<c:if test="${not empty param.errTrungMonHoc and ChiTietCTDT.maMonHoc ne '' and ChiTietCTDT.maHocPhan eq 2 and ChiTietCTDT.kiemTraTrung eq 1}"><b class="error">(X)</b></c:if>
			<c:if test="${not empty param.err and ChiTietCTDT.maMonHoc eq '' and ChiTietCTDT.maHocPhan eq 2}"><b class="error">(*)</b></c:if>
		</td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 2}">disabled</c:if>
		...
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 2}">disabled</c:if>
			...
			<option value = "0">0</option>
			<c:forEach var = "iterator" begin = "1" end = "200">
				<option value = "${iterator }" <c:if test = "${ChiTietCTDT.lyThuyet eq iterator and ChiTietCTDT.maHocPhan eq 2 }">selected</c:if>>${iterator}</option>
			</c:forEach>
		</select></td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 2}">disabled</c:if>
			...
			<option value = "0">0</option>
			<c:forEach var = "iterator" begin = "1" end = "200">
				<option value = "${iterator }" <c:if test = "${ChiTietCTDT.thucHanh eq iterator and ChiTietCTDT.maHocPhan eq 2 }">selected</c:if>>${iterator}</option>
			</c:forEach>
		</select></td>
		
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 2}">disabled</c:if>
				id = "TinhChat_PhanII_${count}" name="cboTinhChat_PhanII_${count}">
			<option value = "Thi" <c:if test="${ChiTietCTDT.tinhChat eq 'Thi' and ChiTietCTDT.maHocPhan eq 2}">selected</c:if>>Thi</option>
			<option value = "Kiểm tra" <c:if test="${ChiTietCTDT.tinhChat eq 'Kiểm tra' and ChiTietCTDT.maHocPhan eq 2}">selected</c:if>>Kiểm tra</option>
			<option value = "Báo cáo" <c:if test="${ChiTietCTDT.tinhChat eq 'Báo cáo' and ChiTietCTDT.maHocPhan eq 2}">selected</c:if>>Báo cáo</option>
		</select></td>
	</tr>
	<c:if test="${ChiTietCTDT.maHocPhan eq 2}">
		<%num++; %>
					...
					<c:when test="${ChuongTrinhDaoTao.tinhTrang eq NEW or ChuongTrinhDaoTao.tinhTrang eq REJECT or ChuongTrinhDaoTao.tinhTrang eq null}">
						<td colspan = 12>							
							<a href = "javascript: addRow(2)">
								<input type="hidden" name="XuLyDong_Phan2" id="XuLyDong" /> 
								<img src="<%=request.getContextPath()%>/images/buttom/themdong.png" alt="Thêm Dòng" border = "0" />
							</a>							
	...
	<tr style="background-color: transparent;">
		<td>&nbsp;</td>
		<td><input type = "checkbox" name="chkAllRow_PhanIII" onclick="selectCheckboxAll(3);"></input></td>
		<td>III</td>
	...
	<c:set var = "num" value = "<%=num %>"></c:set>
	<c:forEach var = "count" begin = "1" end = "<%=Constant.NUM_ROWS_PHAN_3 %>" step = "1">
		<c:set var="ChiTietCTDT" value="${ChuongTrinhDaoTao.chiTietMonHocCTDTModelList[count+num-1]}"></c:set>
	<tr style="background-color: transparent;">
		<td><input type="checkbox" name = "TinhTrangMonHoc_PhanIII_${count}"
			<c:if test="${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 3}">checked</c:if> disabled="disabled"/>
			<input type="hidden" name="MaDeCuong_PhanIII_${count}" 		
				<c:choose>	
					<c:when test="${ChiTietCTDT.maHocPhan eq 3}">
						value="${ChiTietCTDT.maDeCuong}"
					</c:when>
					<c:otherwise>
						value="-1"
			...
			/>
			<input type="hidden" name="TinhTrang_PhanIII_${count}" 
					<c:if test="${ChiTietCTDT.maHocPhan eq 3}">
						value="${ChiTietCTDT.tinhTrang}"
					</c:if>
			/>
			<input type="hidden" name="MaNguoiTaoDeCuong_PhanIII_${count}" 
					<c:if test="${ChiTietCTDT.maHocPhan eq 3}">
						value="${ChiTietCTDT.maNguoiTaoDeCuong}"
					</c:if>
			/>
		</td>
		<td><input type = "checkbox" name = "chkRow_PhanIII_${count}" onclick="selectCheckboxRow(3);"></input></td>
		<td>${count}.</td>
		<td>
			<select <c:if test = "${ChiTietCTDT.tinhTrang ne null and ChiTietCTDT.tinhTrang ne '' and ChiTietCTDT.maHocPhan eq 3}">disabled</c:if>
				id = "MonHoc_PhanIII_${count}" name = "cboMonHoc_PhanIII_${count}" onclick="selectMonHoc('III','${count}');">
				<option value="">--Select--</option>
				<c:forEach var = "MonHocObj" items="${ListMonHoc}">
					<option value = "${MonHocObj.maMonHoc}" <c:if test="${ChiTietCTDT.maMonHoc eq MonHocObj.maMonHoc and ChiTietCTDT.maHocPhan eq 3}">selected</c:if>>${MonHocObj.tenMonHoc}</option>
				</c:forEach>
			</select>
			<c:if test="${(not empty ChiTietCTDT.maDeCuong and ChiTietCTDT.maDeCuong ne -1) and ChiTietCTDT.tinhTrang ne null and ChiTietCTDT.tinhTrang ne NEW and ChiTietCTDT.maHocPhan eq 3}">	
				<a href="<%=request.getContextPath()%>/ISO/DeCuongMonHoc/DeCuong.jsp?maID=${ChiTietCTDT.maDeCuong}">Xem chi tiết</a>
			</c:if>
			<c:if test="${not empty param.errTrungMonHoc and ChiTietCTDT.maMonHoc ne '' and ChiTietCTDT.maHocPhan eq 3 and ChiTietCTDT.kiemTraTrung eq 1}"><b class="error">(X)</b></c:if>
			<c:if test="${not empty param.err and ChiTietCTDT.maMonHoc eq '' and ChiTietCTDT.maHocPhan eq 3}"><b class="error">(*)</b></c:if>
		</td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 3}">disabled</c:if>
		...
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 3}">disabled</c:if>
			...
			<option value = "0">0</option>
			<c:forEach var = "iterator" begin = "1" end = "200">
				<option value = "${iterator }" <c:if test = "${ChiTietCTDT.lyThuyet eq iterator and ChiTietCTDT.maHocPhan eq 3}">selected</c:if>>${iterator}</option>
			</c:forEach>
		</select></td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 3}">disabled</c:if>
			...
			<option value = "0">0</option>
			<c:forEach var = "iterator" begin = "1" end = "200">
				<option value = "${iterator }" <c:if test = "${ChiTietCTDT.thucHanh eq iterator and ChiTietCTDT.maHocPhan eq 3}">selected</c:if>>${iterator}</option>
			</c:forEach>
		</select></td>
		<td><select <c:if test = "${ChiTietCTDT.tinhTrang eq APPROVE and ChiTietCTDT.maHocPhan eq 3}">disabled</c:if>
				id = "TinhChat_PhanIII_${count}" name="cboTinhChat_PhanIII_${count}">
			<option value = "Thi" <c:if test="${ChiTietCTDT.tinhChat eq 'Thi' and ChiTietCTDT.maHocPhan eq 3}">selected</c:if>>Thi</option>
			<option value = "Kiểm tra" <c:if test="${ChiTietCTDT.tinhChat eq 'Kiểm tra' and ChiTietCTDT.maHocPhan eq 3}">selected</c:if>>Kiểm tra</option>
			<option value = "Báo cáo" <c:if test="${ChiTietCTDT.tinhChat eq 'Báo cáo' and ChiTietCTDT.maHocPhan eq 3}">selected</c:if>>Báo cáo</option>
		</select></td>
	</tr>
</c:forEach>
<tr style="background-color: transparent;">

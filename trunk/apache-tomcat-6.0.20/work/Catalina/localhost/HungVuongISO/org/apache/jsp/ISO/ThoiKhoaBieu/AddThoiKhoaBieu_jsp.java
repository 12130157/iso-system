...
public final class AddThoiKhoaBieu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Thêm môn học TKB</title>\r\n");
      out.write("<script language=\"JavaScript\" type=\"text/javascript\">\r\n");
      out.write("var objWindow = new Object();\r\n");
      ...
      out.write("var listSuDungPhong; // list su dung phong\r\n");
      out.write("var kieuBienSoan;\r\n");
      out.write("var soThucHanh = 0;\r\n");
      out.write("var soLyThuyet = 0;\r\n");
      out.write("var lyThuyet;\r\n");
      out.write("var thucHanh;\r\n");
	...
	// tao list su dung phong
      ...
      out.write("\t\tarrSuDungKhongThuocTKB = obj.arrSuDungKhongThuocTKB;\r\n");
      out.write("\t\tarrSuDungThuocTKB = obj.arrSuDungThuocTKB;\r\n");
      out.write("\t\tcreateMonHoc();\r\n");
      ...
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("function createMonHoc()\r\n");
      out.write("{\r\n");
      out.write("\tdocument.getElementById('monHoc').innerHTML = null;\r\n");
      out.write("\tvar opt = new Option('Select','');\r\n");
      out.write("\tdocument.getElementById('monHoc').add(opt,undefined);\r\n");
      out.write("\t");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function selectMonHoc() \r\n");
      out.write("{\r\n");
      out.write("\tdocument.getElementById('phongThucHanh').disabled = false;\r\n");
      out.write("\tdocument.getElementById('SoCa').readonly = false;\r\n");
      out.write("\tdocument.getElementById('phongLyThuyet').disabled = false;\r\n");
      out.write("\t");
	...
	if(deCuongMonHocModelList.size() > 0) {
      ...
      out.write("\t\ttonTai = 0;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(kieuBienSoan == '0' && lyThuyet != '0' && thucHanh != '0')\r\n");
      out.write("\t{\r\n");
      out.write("\t\ttonTai = 1;\t\r\n");
      ...
      out.write("\t//var dong2 = \"<td><input type = 'button' value = 'Uncheck All' id = 'Uncheck' onclick = 'unCheckAll();'/></td>\";\r\n");
      out.write("\t");
	...
	String tenChuong = "";
      ...
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(kieuBienSoan == '1' || kieuBienSoan == '0')\r\n");
      out.write("\t{\r\n");
      out.write("\t\t");
      ...
      out.write("{\r\n");
      out.write("\tdocument.getElementById('TableButton').rows[0].cells[0].innerHTML = \"<input type = 'button' value = 'Tạo bảng' id = 'TaoBang' onclick = 'taoBang()'/> <input type = 'button' value = 'Xóa bảng' id = 'XoaBang' onclick = 'xoaBang()' disabled = 'disabled'/>\";\r\n");
      out.write("}\r\n");
      out.write("function taoBang()\r\n");
      out.write("{\r\n");
      ...
      out.write("\t\t\tdocument.getElementById('monHoc').disabled = true;\r\n");
      ...
      out.write("\tdocument.getElementById('monHoc').disabled = false;\r\n");
      ...
      out.write("}\r\n");
      out.write("function selectKieuDay(act) // tao bang 2\r\n");
      out.write("{\r\n");
      out.write("\tif(kieuBienSoan == '0' && lyThuyet != '0' && thucHanh != '0')\r\n");
      out.write("\t{\r\n");
      ...
      out.write("\telse\r\n");
      out.write("\t{\r\n");
      out.write("\t\tif(document.getElementById('monHoc').value != '')\r\n");
      out.write("\t\t{\r\n");
      ...
      out.write("\t\t\t\t\tsoBuoiMoiTuan++;\r\n");
      out.write("\t\t\tso = -1; \r\n");
      out.write("\t\t\tif(kieuBienSoan == '1')\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\tif(i%((parseInt(thucHanh) + parseInt(lyThuyet))/parseInt(lyThuyet)) == 0)\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\tso = 0;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\ttr.insertCell(4-dem).innerHTML = \"<select name = 'Nhom\" + soBuoiTongCong + \"' id = 'Nhom\" + soBuoiTongCong + \"' \" + disable + selectNhomHoc + \">\" + option + \"</select>\";\r\n");
      ...
      out.write("\t\tif(confirm(\"Bạn có chắc muốn thêm môn học này không ???\"))\r\n");
      ...
      out.write("\r\n");
      out.write("}\r\n");
      out.write("function taoChuoiThuTrongTuan() // tao 1 chuoi thu trong tuan va submit form\r\n");
      out.write("{\r\n");
      ...
      out.write("\tdocument.getElementById('KieuBienSoan').value = kieuBienSoan;\r\n");
      out.write("\tdocument.getElementById('SoTietLyThuyet').value = lyThuyet;\r\n");
      out.write("\tdocument.getElementById('SoTietThucHanh').value = thucHanh;\r\n");
      out.write("\t\r\n");
      ...
      out.write("/thoiKhoaBieuController?themChiTiet=yes\" method=\"post\" name = \"AddThoiKhoaBieu\" onsubmit=\"window.self\">\r\n");
      ...
      out.write("\t\t\t\t\t<input type = \"hidden\" id = \"txtTenMonHoc\" name = \"txtTenMonHoc\"/>\r\n");
      out.write("\t\t\t\t\t<select id=\"monHoc\" onchange=\"selectMonHoc();\" name=\"cboMonHoc\" >\r\n");
      ...
      out.write("\t\t\t\t<input type=\"button\" value = \"Thêm\" onclick=\"taoMonHoc();\"/>\r\n");
      ...
      out.write("\t\t<input type=\"hidden\" name = \"MangChiTietLength\" id = \"MangChiTietLength\" value=\"0\"/>\r\n");
      out.write("\t\t<input type=\"hidden\" name = \"ChuoiMaChiTietTKB\" id = \"ChuoiMaChiTietTKB\" value=\"\"/>\r\n");
      out.write("\t\t<input type=\"hidden\" name = \"ChuoiMaSuDung\" id = \"ChuoiMaSuDung\" value=\"\"/>\r\n");
      out.write("\t</form>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
